...
public class ImageUtils {
    ...
    public static Map<String, Object> resizeDefault(MultipartFile file, String targetDir) throws IOException {
        ...
        String baseDir = uploadDir + currentDate + File.separator + targetDir + File.separator;
    ...
    static{
        ...
        System.out.println(thumHeight);
        System.out.println(thumWidth);
        if(uploadDir==null){
            uploadDir = YmlConfigUtil.getConfigByKey("upload-dir");
        }
        if(thumHeight==null){
