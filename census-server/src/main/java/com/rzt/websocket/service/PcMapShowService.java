...
public class PcMapShowService {
    ...
    @Autowired
    private YiJiPushService service;
    ...
    public Map<String, Object> userInfoFromRedis(String userId) throws Exception {
        ...
        if(userInformation == null) {
            ...
            userInfo = service.execSqlSingleResult(sql, userId);
        ...
        for (String deptId:deptIds) {
            ...
            if(userInformation == null) {
                if(deptId.equals("all")) {
                    ...
                    userList.addAll(service.execSql(userListSql));
                } else {
                    ...
                    userList.addAll(service.execSql(userListSql, deptId));
                }
