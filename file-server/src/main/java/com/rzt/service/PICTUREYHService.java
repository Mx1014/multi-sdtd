...
public class PICTUREYHService extends CurdService<PICTUREYH,PICTUREYHRepository> {
    ...
    public Map<String,Object> fileUpload(MultipartFile multipartFile, PICTUREYH pictureyh) {
        ...
        try {
            ...
            if("true".equals(map.get("success").toString())){
                ...
                result.put("id",String.valueOf(pictureyh.getId()));
    ...
    public Map<String,Object> getImgsBytaskIdAndProcessId(String taskId, String processId,String processType) {
        ...
        String sql = "select id,file_path,FILE_SMALL_PATH from PICTURE_YH where 1=1 ";
    ...
    @Transactional
    public Map<String,Object> fileUploadByType(MultipartFile multipartFile, PICTUREYH pictureyh) {
        Map<String, Object> result = new HashMap<>();
        ...
        try {
            ...
            if("true".equals(map.get("success").toString())){
                ...
                pictureyh.setId(null);
                pictureyh.setCreateTime(new Date());
                pictureyh.setFileName(fileName);
                pictureyh.setFilePath(filePath);
