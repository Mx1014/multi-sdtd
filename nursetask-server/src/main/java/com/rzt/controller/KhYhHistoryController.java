...
public class KhYhHistoryController extends
    ...
    @ResponseBody
    public WebApiResponse listCoordinate(String yhjb, String yhlb, String currentUserId,String queryAll) {
        ...
        return this.service.listCoordinate(yhjb, yhlb, jsonObject,queryAll);
    }
